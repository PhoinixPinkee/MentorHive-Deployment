...
const Profile = () => {
  ...
  return (
    <Dashboard>
      <div className="flex flex-col items-center w-full min-h-screen p-10 bg-gradient-to-r from-yellow-50 to-white">
        <h2 className="mb-10 text-5xl font-bold text-center text-orange-600">
          My Profile
        </h2>
        <div className="flex flex-col w-full max-w-5xl p-8 space-y-10 bg-white shadow-xl rounded-3xl">
          <Spin spinning={loading}>
            <div className="flex justify-center">
              <Avatar
                ...
                className="border-4 border-orange-200 shadow-lg cursor-pointer transform hover:scale-110 transition-all"
              />
            </div>
          </Spin>
          <div className="text-center">
            <h3 className="text-4xl font-semibold text-orange-700">
              {mentorData?.name}
            </h3>
            ...
            <p className="flex items-center justify-center mt-2 text-lg text-gray-700">
              <AiOutlineUser className="mr-2 text-orange-500" />
          ...
          <h3 className="text-2xl font-semibold text-center text-orange-700">
            Connect with Me
          </h3>
          ...
          <Button
            type="primary"
            className="w-full mt-10 text-lg bg-orange-600 rounded-lg hover:bg-orange-700 transition-all"
  ...
  >
    ...
    <Form.Item>
      <Button
        type="primary"
        htmlType="submit"
        className="w-full bg-orange-600 rounded-lg hover:bg-orange-700"
      >
        Save Changes
      </Button>
    </Form.Item>
